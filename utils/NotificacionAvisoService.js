...
const enviarAviso = async (idAviso) => {    
   ...
   if (!aviso) {
        ...
        const respuesta = {envioCorreo:false,     
                            envioMovil:false,
...
const obtenerPreviewAviso = async (avisoHtml,idEmpresa)=>{       
    return await correoService.getHtmlPreviewTemplate(TEMPLATES.TEMPLATE_AVISO,{aviso:avisoHtml},idEmpresa);
};
